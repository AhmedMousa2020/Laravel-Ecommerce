		...
		<div class="container">
			...
			<form wire:submit.prevent="placeOrder" onsubmit="$('#processing').show()">
				<div class="row">
					...
					<p class="row-in-form">
						<label for="fname">Shipping to Different Adress</label>
					...
					<div class="summary-item payment-method">
						...
						@endif
							<div class="wrap-address-billing">
								<p class="row-in-form">
									...
									<input  type="text" name="card-no" value="" placeholder="Your Card Number" wire:model="card_no">
									@error('s_zipcode') <p class="text-danger">{{$message}}</p> @enderror
								</p>
								<p class="row-in-form">
								...
								<p class="row-in-form">
									...
									<input  type="text" name="exp-year" value="" placeholder="YY" wire:model="exp_year">
									@error('s_zipcode') <p class="text-danger">{{$message}}</p> @enderror
								</p>
								<p class="row-in-form">
						...
						<div class="choose-payment-methods">
							<label class="payment-method">
								<input name="payment-method" id="payment-method-bank" value="code" type="radio" wire:model="paymentmode">
