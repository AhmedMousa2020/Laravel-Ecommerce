                                ...
                                <div class="wrap-footer-item">
                                    ...
                                    <div class="item-content">
                                        <div class="wrap-hotline-footer">
                                            ...
                                            <b class="phone-number">{{$settings->phone}} - {{$settings->phone2}}</b>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wrap-footer-item">
                                    ...
                                    <div class="item-content">
                                        <div class="wrap-list-item social-network">
                                            <ul>
                                                <li><a href="{{$settings->twiter}}" class="link-to-item" title="twitter"><i
                                                ...
                                                <li><a href="{{$settings->youtube}}" class="link-to-item" title="youtube"><i
