                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <a href="#" onclick="confirm('are you sure that you want delete this item ?')" wire:click.prevent="deleteProduct({{$product->id}})" style="margin-left:10px; "><i class="fa fa-times fa-2x text-danger"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
