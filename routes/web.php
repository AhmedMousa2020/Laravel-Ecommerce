...
Route::get('/whishlist',WishlistComponent::class)->name('product.wishlist');
//For User
...
Route::middleware(['auth:sanctum',config('jetstream.auth_session'),'verified'])->group(function () {
    ...
    Route::get('/admin/coupon/edit/{coupon_id}', AdminEditCouponComponent::class)->name('admin.editecoupon');
